...
def process_dataset(model, tokenizer, dataset, split_name, index_start=0, index_end=None, do_sample=True):
    ...
    print(f"Selected samples from index {index_start} to {index_end} ({len(filtered_dataset)} samples)")
    ...
    print(f"Pushing {split_name_with_index} dataset to hub...")
    processed_dataset.push_to_hub("wanhin/test_reasoning_1_2e", split=split_name_with_index)
    print(f"{split_name_with_index} dataset pushed successfully!")
