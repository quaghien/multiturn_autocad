...
if __name__ == "__main__":
    ...
    failed_json_path = "failed_ids_wanhin_cad_reasoning_part_en_part_1_0_72000.json"  # Path to your failed samples JSON
    new_dataset_name = "wanhin/retry_output_reasoning_part_1"
    num_threads = 1
